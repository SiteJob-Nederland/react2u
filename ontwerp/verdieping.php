...
foreach ($serviceContent as $slug => $item) {
    ...
    $body .= '<section class="section shell service-intro"><p class="section-kicker">Samen aan de slag</p><h2>Wat kun je van ons verwachten?</h2><p class="reading-intro">' . e($item['context']) . '</p>' . contentCards($item['sections']) . '</section>';
...
$about = infoHero('Over React2u', 'Aandacht raakt.', 'Gezond werken gaat over mensen. Bij React2u verbinden we ervaring in verzuim en re-integratie met persoonlijke aandacht voor werkgever én werknemer.', 'aandacht', 'Professioneel én persoonlijk', 'werkgevers');
...
$protocol = infoHero('Verzuimprotocol', 'Ziek gemeld. Hoe nu verder?', 'Als je niet kunt werken, wil je weten wat je kunt verwachten. Het verzuimprotocol van React2u geeft richting aan het contact en de begeleiding na een ziekmelding.', 'aandacht', 'Duidelijkheid geeft rust', 'werknemers');
