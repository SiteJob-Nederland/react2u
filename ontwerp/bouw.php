...
<section class="section shell" id="over-react2u" aria-labelledby="about-title">
  <div class="about"><div><p class="section-kicker">Dit is React2u</p><h2 id="about-title">Het begint niet<br>bij een dossier.<br><span>Het begint bij jou.</span></h2></div><div class="about-copy"><p>Werk is een belangrijk deel van je leven. Als het even niet gaat, wil je iemand die naast je staat. Die luistert, overzicht geeft en samen met jou kijkt naar wat er wél kan.</p><p>Dat is de aandacht van React2u. Voor werkgevers én werknemers.</p><a class="text-link" href="over-react2u.html">Maak kennis met ons' . arrow() . '</a></div></div>
</section>
<section class="moments-section" aria-labelledby="moments-title" data-slider>
  ...
  <div class="moments-track" id="momenten" tabindex="0" role="region" aria-label="Sfeerbeelden van aandacht, begeleiding en werkplezier">
    <article class="moment" aria-label="1 van 3: Een luisterend oor"><figure>' . photo('aandacht', 'een persoonlijk gesprek in een rustige kamer.', '(max-width:760px) 85vw, 46vw') . '</figure><div class="moment-copy"><span class="moment-kicker">Persoonlijke aandacht</span><h3>Een luisterend oor.</h3><p>Ruimte voor jouw verhaal. Ook voor wat niet meteen wordt gezegd.</p><a class="text-link" href="werknemers.html#begeleiding">Over onze begeleiding' . arrow() . '</a></div></article>
...
foreach ($config['services'] as $service) {
    $services .= '<a class="service" data-service="' . e($service['slug']) . '" href="' . e(trim($service['path'], '/') . '.html') . '"><span class="service-dot" aria-hidden="true"></span><div><h3>' . e($service['title']) . '</h3><p>' . e($service['text']) . '</p></div>' . arrow() . '</a>';
}
...
<section class="subhero" aria-labelledby="contact-title"><div><p class="eyebrow">Kom met ons in contact</p><h1 id="contact-title">Goed dat je<br>contact zoekt.</h1><p class="hero-intro">Een kennismaking voor je organisatie of een vraag over je begeleiding. We horen graag van je.</p></div><figure class="subhero-photo">' . photo('aandacht', 'een aandachtig gesprek.', '(max-width:760px) 90vw, 40vw', true) . '<figcaption>We horen graag<br>jouw verhaal.</figcaption></figure></section>
<div class="contact-options"><section class="contact-option" id="werkgever" aria-labelledby="contact-employer"><p class="section-kicker">Voor werkgevers</p><h2 id="contact-employer">Laten we kennismaken.</h2><p>Bespreek je vraag over verzuim, preventie of ondersteuning voor je organisatie.</p>' . contactMethods() . '</section><section class="contact-option" id="werknemer" aria-labelledby="contact-employee"><p class="section-kicker">Voor werknemers</p><h2 id="contact-employee">Waar kunnen we je bij helpen?</h2><p>Neem contact op met een vraag over React2u of je begeleiding.</p>' . contactMethods() . '</section></div></div>';
